export const pl = {
  ...
  faqPage: {
    ...
    items: [
      ...
      { q: "Jak wynająć magazyn?", a: "Wynajem online zajmuje 5 minut. Wchodzisz na wynajmij.lockit.pl i klikasz Wynajmij boks, wybierasz boks, zakładasz konto, płacisz pierwszy czynsz — i możesz od razu korzystać z magazynu." },
